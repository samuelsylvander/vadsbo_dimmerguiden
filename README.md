...
-   Long delay after starting new project. To fix, either keep modal active then manually clean up on next screen, or change from getServerSideProps to API fetch.
